Perfect. Now let's create the README via PowerShell like we did last time since the browser editor gave us trouble.
...
mkdir active-directory-homelab
...
Notepad will open. Paste this in:
...
Save and close Notepad. Tell me when it's saved.
